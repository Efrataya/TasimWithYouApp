...
public class station2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =inflater.inflate(R.layout.fragment_station2, container, false);

        ImageButton button1=view.findViewById(R.id.to_21);
        button1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_station2_to_station1);
            }
        });



        ImageButton button2=view.findViewById(R.id.to_23);
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_station2_to_station3);
            }
        });
        ...
        CheckBox checkBoxStation1 = view.findViewById(R.id.checkBoxStation2);
            ...
            if (checked) {
                AlertDialog dialog = new AlertDialog.Builder(requireContext())
                        ...
                        .setPositiveButton("כן", (dialogInterface, i) -> {
                            model.markStationComplete(2L);
                            NavHostFragment.findNavController(this)
                                    .navigate(R.id.action_station2_to_station3);
